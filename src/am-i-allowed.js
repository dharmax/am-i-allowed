...
class PrivilegeManager {
    ...
    isAllowed(actor, operation, entity, specialContext) {
        ...
        // @ts-ignore
        const customPermissionChecker = entity.customPermissionChecker || ((_a = entity.constructor) === null || _a === void 0 ? void 0 : _a.customPermissionChecker);
...
class EntityMetaDataLookup {
    ...
    getOrAddMetaData(entityType) {
        ...
        if (!metadata) {
            // @ts-ignore
            metadata = (clazz === null || clazz === void 0 ? void 0 : clazz.permissionsMetaData) || new types_1.PermissionsMetaData(name, {});
    ...
    async findMetaData(entity) {
        ...
        // @ts-ignore
        let metaData = entity.permissionsMetaData || ((_a = entity.constructor) === null || _a === void 0 ? void 0 : _a.permissionsMetaData);
        if (!metaData) {
